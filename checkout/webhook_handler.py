    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                ...
                profile.default_billingCity = shipping_details.address.city
                profile.default_street_address1 = shipping_details.address.line1  # noqa:501
                profile.save()
        ...
        if order_exists:
            ...
            return HttpResponse(
                content=f'Webhook received: {event["type"]} | SUCCESS: Verified order already in database',  # noqa:501
                status=200)
        else:
            order = None
            try:
                ...
                for item_id, item_data in json.loads(cart).items():
                    ...
                    if isinstance(item_data, int):
                        ...
                        for size, quantity in item_data['items_by_size'].items():  # noqa:501
                            order_line_item = OrderLineItem(
                                order=order,
                                product=product,
                                quantity=quantity,
